...
INSERT INTO `departments` (`id`, `hospital_id`, `name`, `description`, `created_at`) VALUES
(1, 1, 'Emergency', 'Emergency and critical care department', '2026-08-03 17:42:57'),
(2, 1, 'Cardiology', 'Heart and cardiovascular department', '2026-08-03 17:42:57'),
(3, 1, 'Pediatrics', 'Child healthcare department', '2026-08-03 17:42:57'),
(4, 1, 'General Medicine', 'General medical care', '2026-08-03 17:42:57'),
(5, 1, 'ICU', 'Intensive Care Unit', '2026-08-03 17:42:57');
...
INSERT INTO `hospitals` (`id`, `hospital_code`, `name`, `phone`, `email`, `address`, `city`, `country`, `status`, `created_at`, `updated_at`) VALUES
(1, 'HOSP-001', 'Main General Hospital', '+250700000000', 'info@hospital.local', 'Hospital Address', 'Kigali', 'Rwanda', 'ACTIVE', '2026-08-03 17:42:57', '2026-08-03 17:42:57');
...
--
-- AUTO_INCREMENT for table `ecg_readings`
--
ALTER TABLE `ecg_readings`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `vital_readings`
--
ALTER TABLE `vital_readings`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `ecg_readings`
--
ALTER TABLE `ecg_readings`
...
--
-- Constraints for table `vital_readings`
--
ALTER TABLE `vital_readings`
